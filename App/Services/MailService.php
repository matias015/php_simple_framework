...
class MailService{
    ...
    static function verificacionMail($mail){
        ...
        $_SESSION['TOKEN_VERIF'] = $token;

        MailService::to($mail,'Confirma tu correo!',"tu codigo es: $token",'');
    }
    ...
    static function resetPwPin($mail){
        ...
        MailService::to($mail,'Cambia tu contraseña!',"Tu codigo de reseteo de contraseña es: $token",'');
    }
}
